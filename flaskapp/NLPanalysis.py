...
class NLPanalysis:
    ...
    def __init__(self, dictionary, nameOfFinalDictionaryOnDisc, fake):

        if (type(dictionary) == dict) and (type(fake) == bool):

            goldenFake = self.__safelyOpen('goldenFake')
            goldenTrue = self.__safelyOpen('goldenTrue')
    ...
    ## DEPRECATED, because "profanity" package was not working under PyCharm
